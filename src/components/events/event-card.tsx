...
const EventCard = ({ event, index, onClick, className = "", style }: EventCardProps) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        <div className="relative px-3 sm:px-4 md:px-6 lg:px-8 pb-6 sm:pb-8 md:pb-10 lg:pb-12" style={{ minHeight: '180px' }}>
          ...
          {/* Title */}
          <h2 className="text-base sm:text-lg md:text-xl font-normal text-gray-900 mb-3 sm:mb-4 md:mb-5 leading-tight transition-colors duration-300 group-hover:text-gray-700" style={{ fontFamily: 'serif' }}>
            {event.title}
          </h2>
