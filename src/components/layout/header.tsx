                ...
                <div className="p-4">
                  <nav className="flex flex-col">
                    ...
                    <div className="flex flex-col space-y-3">
                      <h3 className="text-[#a5cd39] uppercase text-sm font-semibold mb-2">Navigation</h3>

                      {/* Mobile Exhibition Stands with Dropdown */}
                      <div className="relative">
                        <button
                          className={cn(
                            "text-[#2C2C2C] uppercase font-medium w-full text-left py-2",
                            activeLink === "/exhibition-stands" && "text-[#a5cd39]"
                          )}
                          onClick={() => {
                            toggleExhibitionDropdown();
                            setActiveLink("/exhibition-stands");
                        ...
                        {showExhibitionDropdown && (
                          <div className="pl-4 mt-2 bg-gray-100 py-3 px-2 overflow-x-auto rounded">
                            <div className="flex items-center whitespace-nowrap">
                              <Link
                                href="/custom-stands"
                                className={cn(
                                  "text-[#2C2C2C] text-sm uppercase font-medium hover:text-[#a5cd39] transition-colors",
                                  activeLink === "/custom-stands" && "text-[#a5cd39]"
                                )}
                                onClick={() => {
                              ...
                              <Link
                                ...
                                className={cn(
                                  "text-[#2C2C2C] text-sm uppercase font-medium hover:text-[#a5cd39] transition-colors",
                                  activeLink === "/double-deck-stands" && "text-[#a5cd39]"
                                )}
                                onClick={() => {
                              ...
                              <Link
                                ...
                                className={cn(
                                  "text-[#2C2C2C] text-sm uppercase font-medium hover:text-[#a5cd39] transition-colors",
                                  activeLink === "/expo-pavilion-stands" && "text-[#a5cd39]"
                                )}
                                onClick={() => {
