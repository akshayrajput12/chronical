    ...
    const components = city.components || [
        {
            ...
            description:
                "Stay ahead of the curve by researching and implementing the latest exhibition design trends and technologies to create cutting-edge displays.",
            color: "#a5cd39",
            sort_order: 1,
        },
        {
            ...
            description:
                "Develop innovative and creative design concepts that capture attention and effectively communicate your brand message to visitors.",
            color: "#a5cd39",
            sort_order: 2,
        },
        {
            ...
            description:
                "Ensure superior build quality using premium materials and expert craftsmanship for durable and impressive exhibition stands.",
            color: "#a5cd39",
            sort_order: 3,
        },
        {
            ...
            description:
                "Comprehensive project management from concept to completion, ensuring timely delivery and seamless execution of your exhibition.",
            color: "#a5cd39",
            sort_order: 4,
        },
        {
            ...
            description:
                "Professional technical support and maintenance services to ensure your exhibition stand operates flawlessly throughout the event.",
            color: "#a5cd39",
            sort_order: 5,
        },
        {
            ...
            description:
                "Complete post-event services including dismantling, storage, and preparation for future exhibitions to maximize your investment.",
            color: "#a5cd39",
            sort_order: 6,
        },
    ];
