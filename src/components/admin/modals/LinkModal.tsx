...
export default function LinkModal({ 
  ...
  const validateUrl = (urlString: string): boolean => {
    ...
    try {
      ...
      return urlString.startsWith('/') || urlString.startsWith('#') || urlString.startsWith('mailto:')
    }
  }
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            ...
            <ul className="text-xs text-gray-600 space-y-1">
              ...
              <li>• <code>example.com</code> - External (https:// added automatically)</li>
              <li>• <code>/about</code> - Internal page</li>
              <li>• <code>#section</code> - Page anchor</li>
              <li>• <code>mailto:email@example.com</code> - Email link</li>
            </ul>
          </div>
        </div>
