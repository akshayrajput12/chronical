...
export async function getWhySection(): Promise<WhySection | null> {
  try {
    ...
    if (!data || data.length === 0) {
      ...
      if (tableError) {
        console.error('Error fetching from why_sections table:', tableError);
        return null;
      }
      ...
      if (tableData && tableData.length > 0) {
        ...
        return {
          ...
          image_overlay_subheading: tableData[0].image_overlay_subheading
        };
      }
      ...
      return {
        ...
        left_column_text_1: "DWTC Free Zone provides a unique and highly desirable proposition for businesses seeking a competitive and well-regulated ecosystem to operate in regional and global markets. Offering a range of benefits such as 100% foreign ownership, 0% taxes and customs duties, and streamlined procedures for visas and permits, the DWTC free zone is a future-focused ecosystem designed for transformative business growth.",
        left_column_text_2: "We are a progressive and welcoming free zone, open to all businesses. Anchored by world-class infrastructure and flexible company formation, licensing and setup solutions, DWTC Free Zone offers an ideal environment, nurturing a sustainable economy from Dubai.",
        right_column_text: "Spanning from the iconic Sheikh Rashid Tower to the neighboring One Central, DWTC Free Zone offers a diverse range of 1,200+ licensed business activities and is home to more than 1,800 small and medium businesses.",
