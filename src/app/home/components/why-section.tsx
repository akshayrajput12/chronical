    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-7xl mx-auto bg-white shadow-xl p-10 md:p-16 opacity-100 transition-opacity duration-500">
                    {/* Heading */}
                    <div className="text-center mb-8">
                        <h2 className="text-4xl font-rubik font-bold text-[#222] mb-4">
                        ...
                        {/* Subtitle */}
                        <p
                            className="font-markazi text-[21px] text-xl leading-relaxed hover:translate-x-1 hover:text-[#222] transition-all duration-200 text-[#444] max-w-3xl mx-auto mb-16"
                            style={{ fontWeight: "0" }}
                        >
                            {whyData?.subtitle ||
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                        {/* Left column */}
                        <div>
                            <p className="text-[#444] mb-6 font-rubik leading-relaxed">
                            ...
                            <p className="text-[#444] font-rubik leading-relaxed">
                            ...
                            <div className="relative mt-8 h-64 overflow-hidden rounded-lg hover:scale-[1.02] transition-transform duration-300">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#000000cc] to-transparent flex items-end p-6">
                                    <div className="text-white">
                                        ...
                                        <p className="text-2xl font-markazi font-bold">
