            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-7xl mx-auto bg-white shadow-xl p-10 md:p-16 opacity-100 transition-opacity duration-500">
                    ...
                    <div className="text-center mb-8">
                        ...
                        {/* Subtitle */}
                        <p
                            className="font-markazi-text hover:translate-x-1 hover:text-[#222] transition-all duration-200 text-[#444] max-w-3xl mx-auto mb-16 text-2xl"
                            style={{ fontWeight: "0" }}
                        >
                            {whyData?.subtitle ||
                    ...
                    <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                        ...
                        <div>
                            ...
                            <div className="absolute -bottom-24 bg-amber-800 w-[48vw] h-[400px]">
                                <div className="relative mt-8 h-64 overflow-hidden hover:scale-[1.02] transition-transform duration-300">
                                    <Image
                                        src={
                                            whyData?.image_url ||
