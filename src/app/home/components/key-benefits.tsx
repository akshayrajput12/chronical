        ...
        >
            ...
            <div className="absolute inset-0 opacity-10">
                <div className="absolute top-0 left-0 w-full h-full">
                    ...
                    >
                        <path
                            d="M0,500 C200,300 800,300 1000,500 C800,700 200,700 0,500 Z"
                            fill="white"
                        />
                        <path
                            d="M0,700 C200,500 800,500 1000,700 C800,900 200,900 0,700 Z"
                            fill="white"
                        />
                        <path
                            d="M0,300 C200,100 800,100 1000,300 C800,500 200,500 0,300 Z"
                            fill="white"
                        />
                    </svg>
                </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    <h2 className="text-4xl sm:text-5xl font-rubik font-bold text-white mb-4">
                        Key Benefits
                    </h2>
