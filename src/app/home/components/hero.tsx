...
const HeroSection: React.FC = () => {
    ...
    return (
        <section id="hero" className="relative w-full h-[90vh] min-h-[600px] overflow-hidden">
            {/* Background Video */}
            <motion.video
                initial={{ scale: 1.1 }}
                animate={{ scale: 1 }}
            ...
            <div className="relative z-20 flex items-center justify-center h-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 text-center text-white pt-16 md:pt-20">
                <motion.div
                ...
                >
                    <div className="overflow-hidden mb-0">
                        <motion.h1
                            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-rubik font-bold whitespace-normal leading-tight tracking-tight"
                    ...
                    <motion.h2
                        className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-markazi font-semibold mb-4 md:mb-6 lg:mb-8"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.p
                        className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-noto-kufi-arabic font-medium pt-2 max-w-4xl mx-auto leading-relaxed"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.div
                        className="mt-6 md:mt-8 lg:mt-10 xl:mt-12 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        <motion.a
                            ...
                            className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3 md:px-10 md:py-4 lg:px-12 lg:py-5 text-sm sm:text-base md:text-lg lg:text-xl bg-[#a5cd39] text-white font-noto-kufi-arabic font-medium rounded-md hover:bg-[#94b933] transition-colors text-center"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
                        ...
                        <motion.a
                            ...
                            className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-3 md:px-10 md:py-4 lg:px-12 lg:py-5 text-sm sm:text-base md:text-lg lg:text-xl border border-white text-white font-noto-kufi-arabic font-medium rounded-md hover:bg-white/10 transition-colors text-center"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                        >
