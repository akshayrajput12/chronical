...
import { Calendar, MapPin, MessageSquare, Building2, Users, ChevronDown, ArrowLeft, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <section className="bg-white py-4 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <span className="text-sm font-medium uppercase tracking-wide">BACK TO EVENT LIST</span>
          </Link>
        </div>
      </section>
          ...
          <div className="flex items-center justify-center gap-2 md:gap-4 lg:gap-6 xl:gap-8 flex-wrap lg:flex-nowrap">
            ...
            >
              <div className="text-center px-1 md:px-2 lg:px-3">
                ...
                <div className="text-[#a5cd39] font-bold text-xs md:text-xs lg:text-sm uppercase tracking-wider">TIME & DATE</div>
                <div className="h-0.5 md:h-1 w-8 md:w-10 lg:w-12 mx-auto bg-gray-200 my-1 md:my-2 lg:my-3"></div>
                <div className="text-black text-xs md:text-xs lg:text-sm font-medium">{event.dateRange}</div>
              </div>
            ...
            >
              <div className="text-center px-1 md:px-2 lg:px-3">
                ...
                <div className="text-[#a5cd39] font-bold text-xs md:text-xs lg:text-sm uppercase tracking-wider">LOCATION</div>
                <div className="h-0.5 md:h-1 w-8 md:w-10 lg:w-12 mx-auto bg-gray-200 my-1 md:my-2 lg:my-3"></div>
                <div className="text-black text-xs md:text-xs lg:text-sm font-medium">{event.venue}</div>
              </div>
              <div className="border-l h-16 md:h-20 lg:h-24 border-gray-300"></div>
            </motion.div>
            ...
            >
              <div className="text-center px-1 md:px-2 lg:px-3">
                ...
                <div className="text-[#a5cd39] font-bold text-xs md:text-xs lg:text-sm uppercase tracking-wider">EVENT TYPE</div>
                <div className="h-0.5 md:h-1 w-8 md:w-10 lg:w-12 mx-auto bg-gray-200 my-1 md:my-2 lg:my-3"></div>
                <div className="text-black text-xs md:text-xs lg:text-sm font-medium">{event.eventType}</div>
              </div>
              <div className="border-l h-16 md:h-20 lg:h-24 border-gray-300"></div>
            </motion.div>
            ...
            >
              <div className="text-center px-1 md:px-2 lg:px-3">
                ...
                <div className="text-[#a5cd39] font-bold text-xs md:text-xs lg:text-sm uppercase tracking-wider">INDUSTRY</div>
                <div className="h-0.5 md:h-1 w-8 md:w-10 lg:w-12 mx-auto bg-gray-200 my-1 md:my-2 lg:my-3"></div>
                <div className="text-black text-xs md:text-xs lg:text-sm font-medium">{event.industry}</div>
              </div>
              <div className="border-l h-16 md:h-20 lg:h-24 border-gray-300"></div>
            </motion.div>
            ...
            >
              <div className="text-center px-1 md:px-2 lg:px-3">
                ...
                <div className="text-[#a5cd39] font-bold text-xs md:text-xs lg:text-sm uppercase tracking-wider">AUDIENCE</div>
                <div className="h-0.5 md:h-1 w-8 md:w-10 lg:w-12 mx-auto bg-gray-200 my-1 md:my-2 lg:my-3"></div>
                <div className="text-black text-xs md:text-xs lg:text-sm font-medium">{event.audience}</div>
              </div>
              <div className="border-l h-16 md:h-20 lg:h-24 border-gray-300"></div>
            </motion.div>
            ...
            >
              <div className="text-xl md:text-2xl lg:text-3xl border border-[#a5cd39] md:border-2 rounded-full p-2 md:p-3 lg:p-4 w-10 h-10 md:w-12 h-12 lg:w-16 h-16 flex items-center justify-center cursor-pointer hover:bg-[#a5cd39] hover:text-white transition-colors duration-300 text-[#a5cd39]">
                <svg className="w-4 h-4 md:w-5 h-5 lg:w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            >
              <div className="text-center">
                {/* Event Logo */}
                <div className="mb-6">
                  <h2 className="text-6xl font-bold text-gray-800 mb-2">{event.logoText || 'CBBC'}</h2>
                  <p className="text-sm text-gray-600 uppercase tracking-wider font-medium">{event.logoSubtext || 'CONCEPT BIG BRANDS CARNIVAL'}</p>
                </div>

                {/* Organizer Info */}
                <div className="border-t border-gray-300 pt-6">
                  <p className="text-xs text-gray-500 mb-2 uppercase tracking-wider">Organised By</p>
                  <p className="font-semibold text-gray-800 text-base">{event.organizer || 'EXCELLENT BRANDS & U'}</p>
                  <p className="text-sm text-gray-600">{event.organizedBy || 'GENERAL TRADING'}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div>
                <p className="text-gray-700 leading-relaxed text-base">
                  {event.description || 'The CBBC brand sale brings exclusive deals, showcasing over 300 fashion and luxury brands with discounts of up to 75%.'}
                </p>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                <span className="text-gray-600 text-sm font-medium uppercase tracking-wider">FOLLOW EVENT</span>
              ...
              <div className="flex gap-6">
                {otherEvents.map((otherEvent, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    onClick={() => handleOtherEventClick(otherEvent.id)}
                  >
