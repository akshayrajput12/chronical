...
const ContactMap: React.FC<ContactMapProps> = ({ mapSettings }) => {
    ...
    const defaultMapSettings: ContactMapSettings = {
        id: "default",
        map_embed_url:
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3610.1234567890!2d55.2708!3d25.2048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjXCsDEyJzE3LjMiTiA1NcKwMTYnMTQuOSJF!5e0!3m2!1sen!2sae!4v1234567890123",
            ...
            <div className="mx-auto">
                <div className="mx-auto">
                    ...
                    >
                        <div
                            className="w-full"
                            style={{ height: `${displayData.map_height}px` }}
                        >
                            <iframe
