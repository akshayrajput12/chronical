        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="text-base leading-relaxed text-justify">
              Top choice for showcasing national excellence on a global stage. As the premier provider of <span className="text-[#a5cd39] font-medium">country pavilion expo booth in Dubai</span>, we specialize in creating immersive and impactful spaces that highlight the unique offerings of your nation. Our booths offer unparalleled visibility and serve as powerful platforms for promoting your country&apos;s culture, industry, and innovation.
            </p>

            <p className="text-base leading-relaxed text-justify">
              With <span className="text-[#a5cd39] font-medium">Chronicle Exhibits Dubai</span> comprehensive services and attention to detail, you can trust us to elevate your country&apos;s presence at any event. Whether you&apos;re promoting trade, tourism, investment opportunities, our country pavilion exhibition booths provide the perfect platform for showcasing the best of what your nation has to offer.
            </p>
          </motion.div>
        </div>
      </div>
