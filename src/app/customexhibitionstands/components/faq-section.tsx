...
const faqData: FAQItem[] = [
  {
    question: "What is the time it will take to create and construct an exhibition stand that is custom-designed?",
  ...
  {
    question: "Can I reuse my custom-designed exhibition stand in different shows?",
  ...
  {
    question: "What is the cost to employ an expert builder of exhibition stands?",
  ...
  {
    question: "How can I measure the performance of my custom exhibit stand at an exhibition?",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="border-2 rounded-lg overflow-hidden" style={{ borderColor: '#a5cd39' }}>
              {faqData.map((faq, index) => (
                <div key={index} className="border-b last:border-b-0" style={{ borderColor: '#a5cd39' }}>
                  <button
