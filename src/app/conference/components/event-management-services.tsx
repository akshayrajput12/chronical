        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-base text-gray-700 leading-relaxed text-justify max-w-4xl mx-auto">
              We are <strong>licensed & skillful meeting & conference organizers in Dubai</strong>,
              creating unforgettable experiences through our <strong>calculated planning services</strong>. We
              plan all sorts of events in every city across the nation.
            </p>
          </motion.div>
