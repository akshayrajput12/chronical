    ...
    <div className="min-h-screen flex flex-col md:flex-row">
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/reset-password" className="font-medium text-[#a5cd39] hover:text-[#94b933] transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
      ...
      <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-[#a5cd39] to-[#8baa2f] p-8 md:p-16">
        <div className="h-full flex flex-col justify-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-4">Welcome to Chronicle Exhibits Admin</h2>
            <p className="text-lg opacity-90">
              Manage your exhibition content, kiosks, and user accounts from this central dashboard.
            </p>
          </motion.div>
          ...
          >
            <h3 className="font-semibold text-xl mb-3 text-white">Admin Features</h3>
            <ul className="text-white space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span>Configure kiosk displays and interactions</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span>View analytics and user engagement data</span>
              </li>
            </ul>
          </motion.div>
        </div>
