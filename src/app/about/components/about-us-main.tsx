...
const AboutUsMain = () => {
  ...
  return (
    <section ref={ref} className="pt-36 md:pt-48 lg:pt-56 pb-20 bg-white overflow-hidden">
                    ...
                    <div className="absolute left-0 bottom-0 z-20">
                      <div className="flex flex-col">
                        <div className="bg-transparent px-8 py-1">
                          <h3 className="text-white text-7xl font-bold leading-tight">ESC</h3>
                        </div>
                        <div className="bg-transparent px-8 py-1">
                          <h4 className="text-[#f0c419] text-6xl font-bold leading-tight">INDIA</h4>
                        </div>
                      </div>
                    </div>
                  </div>
