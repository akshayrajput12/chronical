        ...
        <div className="space-y-2">
            ...
            {currentUrl && (
                <div className="relative w-32 h-32 rounded-lg overflow-hidden border">
                    ...
                    />
                    <button
                        onClick={() => handleInputChange(field as keyof EventInput, "")}
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        variant="outline"
                        onClick={() => {
                            setImageBrowserType(field as 'featured' | 'hero' | 'logo');
                ...
                {currentUrl && (
                    <Input
                        ...
                        value={currentUrl}
                        onChange={(e) => handleInputChange(field as keyof EventInput, e.target.value)}
                    />
                )}
            </div>
        </div>
    ...
    return (
        ...
        >
                            ...
                            <TabsContent value="description" className="space-y-6 mt-6">
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        <h4 className="font-medium text-blue-900 mb-2">💡 Tips for Great Event Descriptions</h4>
                                        <ul className="text-sm text-blue-800 space-y-1">
                                            <li>• Include key highlights and unique features of your event</li>
                                            <li>• Mention notable speakers, exhibitors, or attractions</li>
                                            <li>• Add practical information like parking, accessibility, etc.</li>
                                            <li>• Use headings and bullet points for better readability</li>
                                            <li>• Include calls-to-action for registration or inquiries</li>
                                        </ul>
                                    </div>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="gallery" className="space-y-6 mt-6">
                                <div className="space-y-6">
                                    <div className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">
                                                Add images to showcase your event. These will be displayed in the event gallery section.
                                            </p>
                                        </div>
                                        <Button
                                            type="button"
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                        <h4 className="font-medium text-yellow-900 mb-2">📸 Gallery Best Practices</h4>
                                        <ul className="text-sm text-yellow-800 space-y-1">
                                            <li>• Use high-quality images that showcase your event</li>
                                            <li>• Include a mix of venue shots, activities, and attendee photos</li>
                                            <li>• Optimize images for web (recommended: under 2MB each)</li>
                                            <li>• Add descriptive alt text for accessibility</li>
                                            <li>• Arrange images in order of importance</li>
                                        </ul>
                                    </div>
                                </div>
                            </TabsContent>
            ...
            <ImageBrowser
                ...
                category={
                    imageBrowserType === 'hero' ? 'heroes' :
                    imageBrowserType === 'gallery' ? 'galleries' : 'events'
                }
