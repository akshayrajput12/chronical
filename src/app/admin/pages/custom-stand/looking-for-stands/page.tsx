...
const CustomStandLookingForStandsEditor = () => {
  ...
  const handleInputChange = (field: keyof CustomExhibitionLookingForStands, value: string) => {
    setData(prev => ({
      ...prev,
      [field]: value,
    }));
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading looking for stands section...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Looking for Stands Section</h1>
                <p className="text-gray-600">Manage the call-to-action section with contact information</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link
        ...
        >
          ...
          {/* Preview */}
          <div className="mt-8 p-6 rounded-lg" style={{ backgroundColor: data.background_color }}>
