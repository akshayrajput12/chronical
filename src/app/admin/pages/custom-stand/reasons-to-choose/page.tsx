...
const CustomStandReasonsToChooseEditor = () => {
    ...
    const handleInputChange = (
        field: keyof CustomExhibitionReasonsToChoose,
        value: string,
    ) => {
        setData(prev => ({
            ...prev,
            ...
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">
                        Loading reasons to choose section...
                    </p>
                </div>
            </div>
        );
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">
                                    Manage the reasons to choose our services
                                    content
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                This paragraph explains the company's approach
                                to combining creativity and functionality.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="text-sm text-gray-500 mt-1">
                                This paragraph highlights the company's
