    ...
    const sections = [
        {
            ...
            title: "Hero Section",
            description:
                "Main banner with title, subtitle, and background image",
        ...
        },
        {
            ...
            description:
                "Introduction section about being a leading contractor",
        ...
        },
        {
            ...
            title: "Promote Brand",
            description:
                "Section about promoting brand and services with image",
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">
                                Manage all content sections for the custom
