...
const ExpoPavilionStandParagraphSectionEditor = () => {
    ...
    const handleInputChange = (field: keyof ExpoPavilionParagraphSection, value: any) => {
        setData(prev => ({
            ...prev,
            [field]: value,
        }));
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            const success = await saveExpoPavilionParagraphSection(data.paragraph_content);
            if (success) {
...
export default ExpoPavilionStandParagraphSectionEditor;
