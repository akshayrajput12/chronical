          ...
          <div className="mb-16">
            ...
            >
              <p className="text-gray-700 text-center">
                When it comes to taking part in trade shows exhibitors are nowadays looking for digital, interactive & cost-efficient solutions to represent their brand. Customer satisfaction is the main concern of every exhibitor for a successful trade show experience. This is why their interest is shifting towards customized, self-service & engaging <span className="font-semibold text-[#a5cd39]">custom Kiosk manufacturers in Dubai</span> solutions to offer convenience to visitors & address the needs of the customers better.
              </p>
            </motion.div>
          </div>
