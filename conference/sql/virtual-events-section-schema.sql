-- Virtual Events Section Schema
-- Complete database schema for the Virtual Events Section of the conference page
-- 
-- 🎯 PURPOSE: Dynamic content management for virtual events section
-- 📊 TABLES: virtual_events_sections, virtual_events_images
-- 🗄️ STORAGE: virtual-events-section-images bucket
